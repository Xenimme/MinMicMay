...
var steering_angle = randf_range (40, 49)
var interest = 0
var FOREDET
var friction = -55
var drag = -0.06
var min_speed = 0
var engine_power = randf_range(480, 530)
var brake = (engine_power * randf_range(-3, -3.5))
var dir
var RayLeft = []
var RayRight = []
var IntLeft : float
...
func set_speed():
	if FOREDET == 0:
		acceleration = transform.x * (engine_power * randf_range(0.01, 1.2))
	else:
